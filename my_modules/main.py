...
def save_req_data(location, search_term):
    ...
    while True:
        ...
        for item in items.values():
            ...
            if name:
                required_data['data'].append({'name': name, 'latitude': latitude, 'longitude': longitude})


        ech = ech + 1

        required_data['latest_ech'] = ech
